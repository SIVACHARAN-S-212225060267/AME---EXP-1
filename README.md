...
13. Matched Termination: These are used for terminating the waveguide systems operating at low average power and are designed to absorball the applied power assuring low SWR. Where a matched load is required as in the measurement of reflection, discontinuities of obstacle in waveguide systems, these components are used. These are also employed as a precise reference loads with tee junctions, directional couplers etc.
